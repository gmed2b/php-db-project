<div id="add-section-modal" class="modal rounded-lg">
      ...
      <div class="p-4 md:p-5 space-y-4">
        <div class="grid grid-cols-1 gap-2">
          <div class="grid grid-cols-4 items-center">
            <label class="text-gray-500 font-bold pr-4" for="fm-code-section">
              Code section </label>
            <div class="col-span-3">
              <input type="text" id="fm-code-section" name="code_section"
          ...
          <div class="grid grid-cols-4 items-center">
            <label class="text-gray-500 font-bold pr-4" for="fm-debut-saison">
              Début de saison</label>
            <div class="col-span-3">
              <input type="date" id="fm-debut-saison" name="debut_saison"
                class="w-11/12 p-2 text-gray-700 border-2 border-gray-200 rounded leading-tight appearance-none focus:outline-none focus:bg-white focus:border-blue-500">
            </div>
          </div>
        </div>
