<div id="add-adherant-modal" class="modal rounded-lg">
    ...
    <div class="relative bg-white rounded-lg shadow ">
      ...
      <div class="p-4 md:p-5 space-y-4">
        <div class="grid grid-cols-1 gap-2">
          ...
          <div class="grid grid-cols-4 items-center">
            <label class="text-gray-500 font-bold pr-4" for="fm-date-naissance">
              Date de naissance</label>
            <div class="col-span-3">
              <input type="date" id="fm-date-naissance" name="date_naissance"
                class="w-11/12 p-2 text-gray-700 border-2 border-gray-200 rounded leading-tight appearance-none focus:outline-none focus:bg-white focus:border-blue-500">
            </div>
          </div>
        </div>
